  ...
  return (
    ...
    >
      <div className="flex items-start space-x-3">
        ...
        {/* Action Buttons */}
        <div className="flex space-x-1 opacity-0 group-hover:opacity-100 transition-opacity self-start mt-0.5">
          {!task.completed && (
            <Button
              variant="ghost"
              onClick={(e) => {
          ...
          <Button
            ...
            className="text-gray-500 hover:text-red-500 w-9 h-9 p-0"
          >
